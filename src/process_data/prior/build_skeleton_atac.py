...
Output: PRIOR_DIR/skeleton_atac.csv  (source, target, edge)
Needs scglue + the dataset's ATAC h5ad; run inside the scglue singularity image.
"""
...
par = {
    ...
    'temp_dir':        f'temp/skeleton_atac_{DATASET}',
    'out_skeleton':    f'{PRIOR_DIR}/skeleton_atac.csv',
...
if __name__ == '__main__':
    ...
    skeleton = skeleton[['source', 'target']].drop_duplicates()
