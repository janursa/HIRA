...
# - datasets
DISCOVERY_COHORTS = ['data1' -> 'onek1k', 'data7_allTPs_jalil' -> 'abf300', 'data12' -> 'zhang', 'data13_Korean' -> 'aida_korean', 'data13_Japanese' -> 'aida_japanese']

{'onek1k':'OneK1K','abf300': 'ABF300', 'zhang': 'Zhang', 'aida_korean': 'AIDA: Korean', 'aida_japanese': 'AIDA: Japanese', 'perez_sle': 'Perez: SLE'}
...
set2_colors = sns.color_palette("Set2", n_colors=len(DISCOVERY_COHORTS)+5)
palette_datasets = {d: color for d, color in zip(DISCOVERY_COHORTS+['CXCL9', 'op', 'parsebioscience'], set2_colors)}
