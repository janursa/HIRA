...
## VIASH START
par = {
  'multiomics_rna': 'output/processed_data/test_adata.h5ad',
  'tf_all': '../input/resources_test/prior/tf_all.csv',
  'prediction': 'output/prediction_scgpt.csv',
  'max_n_links': 50000,
  'model_file': 'input/scgpt/finetuned_scGPT_adamson/best_model.pt',
  'model_config_file': 'input/scgpt/finetuned_scGPT_adamson/args.json',
  'vocab_file': 'input/scgpt/finetuned_scGPT_adamson/vocab.json',
  'n_bins': 51,
  'batch_size': 16,
  'condition': 'cell_type'
}
