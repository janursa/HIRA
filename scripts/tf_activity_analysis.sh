...
# python src/feature_association/post_condition_analysis.py --dataset CXCL9 --analysis-type perturbation --data-type bulk --feature-type tf_activity --cell-types CD4T --agreement opposite --skip-overview --skip-pathway
