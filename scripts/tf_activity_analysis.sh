...
# python src/experiments/post_condition_analysis.py --dataset op --analysis-type perturbation --data-type bulk --feature-type tf_activity --cell-types CD4T CD8T --agreement opposite
...
python src/experiments/post_condition_analysis.py --dataset CXCL9 --analysis-type perturbation --data-type bulk --feature-type tf_activity --cell-types CD4T CD8T --agreement opposite --skip-overview --skip-pathway
