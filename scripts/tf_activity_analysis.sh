...
# python src/feature_association/run_analysis.py  --dataset op --cell-types CD4T --data-type bulk --feature-type tf_activity --association-type grouped 
# python src/experiments/post_condition_analysis.py --dataset op --analysis-type perturbation --data-type bulk --feature-type tf_activity --cell-types CD4T --agreement opposite
