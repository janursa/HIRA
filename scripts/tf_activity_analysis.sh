...
# python src/feature_association/post_condition_analysis.py --dataset "perez_sle" --analysis-type disease --data-type bulk --feature-type tf_activity --cell-types all --skip-pathway
...
# echo "---------------------------------------------------------- op -----------------------------------------------------------------"
# python src/feature_association/run_analysis.py  --dataset op --cell-types all --data-type sc --feature-type tf_activity --association-type grouped 
# python src/feature_association/post_condition_analysis.py --dataset op --analysis-type perturbation --data-type sc --feature-type tf_activity --cell-types all --agreement opposite
